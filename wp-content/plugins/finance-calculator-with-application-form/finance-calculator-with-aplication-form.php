...
Copyright (C) 2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018 Ciprian Popescu (getbutterfly@gmail.com)
...
function wpfc_plugin_options() {
	...
	<div class="wrap">
		...
		<form method="post" action="">
			...
			<p>
				<input type="number" class="regular-text" name="wpfc_finance_rate" id="wpfc_finance_rate" value="<?php echo $wpfc_finance_rate; ?>" min="0" max="100" step="0.01"> <label for="wpfc_finance_rate">Finance Rate <span class="description">- Monthly payment will be calculated using this default rate.</span></label>
			</p>
			<p>
				<input type="email" class="regular-text" name="wpfc_application_email" id="wpfc_application_email" value="<?php echo $wpfc_application_email; ?>" class="regular-text"> <label for="wpfc_application_email">Application Email</label>
				<br>
				<span class="description">Application emails will be sent to this address.</span>
			</p>
			<p>
				<input type="text" class="regular-text" name="wpfc_currency" id="wpfc_currency" value="<?php echo $wpfc_currency; ?>" size="3"> <label for="wpfc_currency">Currency Code <span class="description">- Currency used in application emails. Use USD, EUR, GBP, YEN/JPY.</span></label>
				<br>
				<input type="text" class="regular-text" name="wpfc_currency_symbol" id="wpfc_currency_symbol" value="<?php echo $wpfc_currency_symbol; ?>" size="3"> <label for="wpfc_currency_symbol">Currency Symbol <span class="description">- Currency used in application emails. Use characters ($, &euro;, &pound;, &yen;) for symbol.</span></label>
			</p>
			<p>
...
function display_finance_calculator($atts) {
	...
	if (isset($_POST['submit'])) {
		...
		<form action="' . $_SERVER['REQUEST_URI'] . '" method="post" name="form1" class="wpfcs-container">
			...
			<p>
				...
				$display .= '</select> * ' . __('Date of Birth', 'wpfc') . '<br>
			...
			<p>
				...
				<input type="text" size="15" name="wpfc_accn"> * ' . __('Account Number', 'wpfc') . '
				<input type="text" size="15" name="wpfc_bank_sc"> * ' . __('Sort Code', 'wpfc') . '
				<input type="number" min="0" max="100" name="wpfc_bank_time"> * ' . __('Time With Bank (years)', 'wpfc') . '
			</p>
	...
	elseif(isset($_POST['submit2'])) {
		...
		$message = 
			...
			'' . __('Sort Code', 'wpfc') . ': ' . $_POST['wpfc_bank_sc'] . '<br>' .
			'' . __('Address', 'wpfc') . ': ' . $_POST['wpfc_address'] . '<br>' .
			'' . __('Bank', 'wpfc') . ': ' . $_POST['wpfc_bank'] . '<br>' .
			'' . __('Time With Bank', 'wpfc') . ': ' . $_POST['wpfc_bank_time'] . '<br>' .
			...
			<table border="0" summary="form">
				<tbody>';
					...
					<tr>
						...
						<td><input name="Rate" value="' . $f_rate . '" type="number" min="0" max="100" step="0.01" onfocus="Calculate();">%</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>
							' . $f_symbol . ' <input value="0" name="monthpay1" size="7" readonly type="text">/' . __('month', 'wpfc') . '
					...
					<tr>
						...
						<td>
							' . $f_symbol . ' <input value="0" name="monthpay2" size="7" readonly type="text">/' . __('month', 'wpfc') . '
					...
					<tr>
						...
						<td>
							' . $f_symbol . ' <input value="0" name="monthpay3" size="7" readonly type="text">/' . __('month', 'wpfc') . '
					...
					<tr>
						...
						<td>
							' . $f_symbol . ' <input value="0" name="monthpay4" size="7" readonly type="text">/' . __('month', 'wpfc') . '
					...
					<tr>
						...
						<td>
							' . $f_symbol . ' <input value="0" name="monthpay5" size="7" readonly type="text">/' . __('month', 'wpfc') . '
